    ...
    <>
      ...
      <div className="flex gap-1 mb-6 border-b border-gray-200 dark:border-slate-800">
        ...
        <a
          ...
          className="px-4 py-2.5 text-sm font-medium border-b-2 border-transparent text-gray-400 hover:text-violet-600 dark:text-slate-500 dark:hover:text-violet-300 hover:border-violet-500 dark:hover:border-violet-400 transition-colors -mb-px flex items-center gap-1.5"
        >
