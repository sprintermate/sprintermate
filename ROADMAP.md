...
- [ ] Production ortam için postgres seçeneği olmalı.
...
- [ ] Proje kullanılmaya başlandıktan sonra open-source edelim.
...
- [x] Moderatörlüğü devretme özelliği olsun ve aynı aı tahminleri birebir tüm moderatörlük devredilen kişiye verilsin (kişi üstüne tıklayıp moderatörlük devret denilebilir!) veya herkes moderatör olur
